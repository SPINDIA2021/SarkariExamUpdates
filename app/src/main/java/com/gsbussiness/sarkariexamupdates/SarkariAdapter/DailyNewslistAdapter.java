...
public class DailyNewslistAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    String nativeid;
    ...
    public DailyNewslistAdapter(Context context, ArrayList<GovtJobModal> arrayList, OnListClick onListClick) {
