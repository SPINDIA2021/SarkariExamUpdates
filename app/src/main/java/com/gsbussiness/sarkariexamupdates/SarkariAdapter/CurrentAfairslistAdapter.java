...
public class CurrentAfairslistAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    String nativeid;
    ...
    public CurrentAfairslistAdapter(Context context, ArrayList<GovtJobModal> arrayList,OnListClick onListClick) {
